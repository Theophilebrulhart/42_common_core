...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/29 14:17:50 by tbrulhar          #+#    #+#             */
/*   Updated: 2022/12/05 20:26:45 by tbrulhar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	cd(char **argv)
{
	...
	if (chdir(argv[1]) < 0)
	{
		write(2, "error: cd: cannot change to ", ft_strlen("error: cd: cannot change to "));
